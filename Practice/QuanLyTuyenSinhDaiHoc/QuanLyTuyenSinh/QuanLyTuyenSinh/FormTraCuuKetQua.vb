...
Public Class FormTraCuuKetQua
    ...
    Private Sub FormTraCuuKetQua_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        load_cbx_MaNganh()
    ...
    Private Sub ThốngKêToolStripMenuItem_Click(sender As System.Object, e As System.EventArgs) Handles ThốngKêToolStripMenuItem.Click
        FormThongke.Show()
        Me.Hide()
    End Sub
